...
namespace SDK.Script.SkyCreatorPluginSDK
{
    public class SkyCreator : Actor
    {
        public SkyCreator(nint addr) : base(addr) { }
        ...
        public SkyCreatorWeatherPreset EditorWeatherPreset { get { return this[nameof(EditorWeatherPreset)].As<SkyCreatorWeatherPreset>(); } set { this["EditorWeatherPreset"] = value; } }
        public SkyCreatorWeatherSettings EditorWeatherSettings { get { return this[nameof(EditorWeatherSettings)].As<SkyCreatorWeatherSettings>(); } set { this["EditorWeatherSettings"] = value; } }
        ...
        public SkyCreatorWeatherSettings WeatherSettings { get { return this[nameof(WeatherSettings)].As<SkyCreatorWeatherSettings>(); } set { this["WeatherSettings"] = value; } }
        ...
        public CelestialPositionData SunPositionData { get { return this[nameof(SunPositionData)].As<CelestialPositionData>(); } set { this["SunPositionData"] = value; } }
        ...
        public CelestialPositionData MoonPositionData { get { return this[nameof(MoonPositionData)].As<CelestialPositionData>(); } set { this["MoonPositionData"] = value; } }
        ...
        public Array<SkyCreatorLightningParameters> LightningParameters { get { return new Array<SkyCreatorLightningParameters>(this[nameof(LightningParameters)].Address); } }
        ...
        public SkyCreatorWindSettings EditorIndependentWindSettings { get { return this[nameof(EditorIndependentWindSettings)].As<SkyCreatorWindSettings>(); } set { this["EditorIndependentWindSettings"] = value; } }
        ...
        public void SetWindSettings(SkyCreatorWindSettings InWindSettings) { Invoke(nameof(SetWindSettings), InWindSettings); }
        public void SetWindIndependentSettings(SkyCreatorWindSettings InWindSettings) { Invoke(nameof(SetWindIndependentSettings), InWindSettings); }
        public void SetWeatherSettings(SkyCreatorWeatherSettings InWeatherSettings) { Invoke(nameof(SetWeatherSettings), InWeatherSettings); }
        public void SetWeatherMaterialFXSettings(SkyCreatorWeatherMaterialFXSettings InWeatherMaterialFXSettings) { Invoke(nameof(SetWeatherMaterialFXSettings), InWeatherMaterialFXSettings); }
        public void SetWeatherFXSettings(SkyCreatorWeatherFXSettings InWeatherFXSettings) { Invoke(nameof(SetWeatherFXSettings), InWeatherFXSettings); }
        public void SetVolumetricCloudSettings(SkyCreatorVolumetricCloudSettings InVolumetricCloudSettings) { Invoke(nameof(SetVolumetricCloudSettings), InVolumetricCloudSettings); }
        ...
        public void SetSunLightSettings(SkyCreatorSunLightSettings InSunLightSettings) { Invoke(nameof(SetSunLightSettings), InSunLightSettings); }
        ...
        public void SetStarMapSettings(SkyCreatorStarMapSettings InStarMapSettings) { Invoke(nameof(SetStarMapSettings), InStarMapSettings); }
        public void SetStarMapAdditionalRotation(Vector NewValue) { Invoke(nameof(SetStarMapAdditionalRotation), NewValue); }
        public void SetSkyLightSettings(SkyCreatorSkyLightSettings InSkyLightSettings) { Invoke(nameof(SetSkyLightSettings), InSkyLightSettings); }
        public void SetSkyAtmosphereSettings(SkyCreatorSkyAtmosphereSettings InSkyAtmosphereSettings) { Invoke(nameof(SetSkyAtmosphereSettings), InSkyAtmosphereSettings); }
        ...
        public void SetPostProcessSettings(SkyCreatorPostProcessSettings InPostProcessSettings) { Invoke(nameof(SetPostProcessSettings), InPostProcessSettings); }
        ...
        public void SetMoonLightSettings(SkyCreatorMoonLightSettings InMoonLightSettings) { Invoke(nameof(SetMoonLightSettings), InMoonLightSettings); }
        ...
        public void SetExponentialHeightFogSettings(SkyCreatorExponentialHeightFogSettings InExponentialHeightFogSettings) { Invoke(nameof(SetExponentialHeightFogSettings), InExponentialHeightFogSettings); }
        public void SetEditorWeatherSettings(SkyCreatorWeatherSettings NewValue) { Invoke(nameof(SetEditorWeatherSettings), NewValue); }
        public void SetEditorWeatherPreset(SkyCreatorWeatherPreset NewValue) { Invoke(nameof(SetEditorWeatherPreset), NewValue); }
        ...
        public void SetBackgroundCloudSettings(SkyCreatorBackgroundCloudSettings InBackgroundCloudSettings) { Invoke(nameof(SetBackgroundCloudSettings), InBackgroundCloudSettings); }
        ...
        public void LerpWindSettings(SkyCreatorWindSettings InWindSettingsA, SkyCreatorWindSettings InWindSettingsB, float Alpha) { Invoke(nameof(LerpWindSettings), InWindSettingsA, InWindSettingsB, Alpha); }
        public void LerpWindIndependentSettings(SkyCreatorWindSettings InWindSettingsA, SkyCreatorWindSettings InWindSettingsB, float Alpha) { Invoke(nameof(LerpWindIndependentSettings), InWindSettingsA, InWindSettingsB, Alpha); }
        ...
        public void LerpWeatherSettings(SkyCreatorWeatherSettings InWeatherSettingsA, SkyCreatorWeatherSettings InWeatherSettingsB, float Alpha) { Invoke(nameof(LerpWeatherSettings), InWeatherSettingsA, InWeatherSettingsB, Alpha); }
        public void LerpWeatherMaterialFXSettings(SkyCreatorWeatherMaterialFXSettings InWeatherMaterialFXSettingsA, SkyCreatorWeatherMaterialFXSettings InWeatherMaterialFXSettingsB, float Alpha) { Invoke(nameof(LerpWeatherMaterialFXSettings), InWeatherMaterialFXSettingsA, InWeatherMaterialFXSettingsB, Alpha); }
        public void LerpWeatherFXSettings(SkyCreatorWeatherFXSettings InWeatherFXSettingsA, SkyCreatorWeatherFXSettings InWeatherFXSettingsB, float Alpha) { Invoke(nameof(LerpWeatherFXSettings), InWeatherFXSettingsA, InWeatherFXSettingsB, Alpha); }
        public void LerpVolumetricCloudSettings(SkyCreatorVolumetricCloudSettings InVolumetricCloudSettingsA, SkyCreatorVolumetricCloudSettings InVolumetricCloudSettingsB, float Alpha) { Invoke(nameof(LerpVolumetricCloudSettings), InVolumetricCloudSettingsA, InVolumetricCloudSettingsB, Alpha); }
        public void LerpSunLightSettings(SkyCreatorSunLightSettings InSunLightSettingsA, SkyCreatorSunLightSettings InSunLightSettingsB, float Alpha) { Invoke(nameof(LerpSunLightSettings), InSunLightSettingsA, InSunLightSettingsB, Alpha); }
        public void LerpStarMapSettings(SkyCreatorStarMapSettings InStarMapSettingsA, SkyCreatorStarMapSettings InStarMapSettingsB, float Alpha) { Invoke(nameof(LerpStarMapSettings), InStarMapSettingsA, InStarMapSettingsB, Alpha); }
        ...
        public void LerpSkyLightSettings(SkyCreatorSkyLightSettings InSkyLightSettingsA, SkyCreatorSkyLightSettings InSkyLightSettingsB, float Alpha) { Invoke(nameof(LerpSkyLightSettings), InSkyLightSettingsA, InSkyLightSettingsB, Alpha); }
        public void LerpSkyAtmosphereSettings(SkyCreatorSkyAtmosphereSettings InSkyAtmosphereSettingsA, SkyCreatorSkyAtmosphereSettings InSkyAtmosphereSettingsB, float Alpha) { Invoke(nameof(LerpSkyAtmosphereSettings), InSkyAtmosphereSettingsA, InSkyAtmosphereSettingsB, Alpha); }
        ...
        public void LerpPostProcessSettings(SkyCreatorPostProcessSettings InPostProcessSettingsA, SkyCreatorPostProcessSettings InPostProcessSettingsB, float Alpha) { Invoke(nameof(LerpPostProcessSettings), InPostProcessSettingsA, InPostProcessSettingsB, Alpha); }
        public void LerpMoonLightSettings(SkyCreatorMoonLightSettings InMoonLightSettingsA, SkyCreatorMoonLightSettings InMoonLightSettingsB, float Alpha) { Invoke(nameof(LerpMoonLightSettings), InMoonLightSettingsA, InMoonLightSettingsB, Alpha); }
        public void LerpExponentialHeightFogSettings(SkyCreatorExponentialHeightFogSettings InExponentialHeightFogSettingsA, SkyCreatorExponentialHeightFogSettings InExponentialHeightFogSettingsB, float Alpha) { Invoke(nameof(LerpExponentialHeightFogSettings), InExponentialHeightFogSettingsA, InExponentialHeightFogSettingsB, Alpha); }
        public void LerpBackgroundCloudSettings(SkyCreatorBackgroundCloudSettings InBackgroundCloudSettingsA, SkyCreatorBackgroundCloudSettings InBackgroundCloudSettingsB, float Alpha) { Invoke(nameof(LerpBackgroundCloudSettings), InBackgroundCloudSettingsA, InBackgroundCloudSettingsB, Alpha); }
        public SkyCreatorWindSettings GetWindSettings() { return Invoke<SkyCreatorWindSettings>(nameof(GetWindSettings)); }
        public SkyCreatorWeatherSettings GetWeatherSettings() { return Invoke<SkyCreatorWeatherSettings>(nameof(GetWeatherSettings)); }
        public SkyCreatorWeatherMaterialFXSettings GetWeatherMaterialFXSettings() { return Invoke<SkyCreatorWeatherMaterialFXSettings>(nameof(GetWeatherMaterialFXSettings)); }
        public SkyCreatorWeatherFXSettings GetWeatherFXSettings() { return Invoke<SkyCreatorWeatherFXSettings>(nameof(GetWeatherFXSettings)); }
        public SkyCreatorVolumetricCloudSettings GetVolumetricCloudSettings() { return Invoke<SkyCreatorVolumetricCloudSettings>(nameof(GetVolumetricCloudSettings)); }
        ...
        public SkyCreatorSunLightSettings GetSunLightSettings() { return Invoke<SkyCreatorSunLightSettings>(nameof(GetSunLightSettings)); }
        public SkyCreatorStarMapSettings GetStarMapSettings() { return Invoke<SkyCreatorStarMapSettings>(nameof(GetStarMapSettings)); }
        public Rotator GetStarMapRotation() { return Invoke<Rotator>(nameof(GetStarMapRotation)); }
        public SkyCreatorSkyLightSettings GetSkyLightSettings() { return Invoke<SkyCreatorSkyLightSettings>(nameof(GetSkyLightSettings)); }
        public SkyCreatorSkyAtmosphereSettings GetSkyAtmosphereSettings() { return Invoke<SkyCreatorSkyAtmosphereSettings>(nameof(GetSkyAtmosphereSettings)); }
        public SkyCreatorPostProcessSettings GetPostProcessSettings() { return Invoke<SkyCreatorPostProcessSettings>(nameof(GetPostProcessSettings)); }
        ...
        public SkyCreatorMoonLightSettings GetMoonLightSettings() { return Invoke<SkyCreatorMoonLightSettings>(nameof(GetMoonLightSettings)); }
        public Vector GetLastLightningPosition() { return Invoke<Vector>(nameof(GetLastLightningPosition)); }
        public SkyCreatorExponentialHeightFogSettings GetExponentialHeightFogSettings() { return Invoke<SkyCreatorExponentialHeightFogSettings>(nameof(GetExponentialHeightFogSettings)); }
        public float GetCloudDensityAtPosition(Vector Position) { return Invoke<float>(nameof(GetCloudDensityAtPosition), Position); }
        public SkyCreatorBackgroundCloudSettings GetBackgroundCloudSettings() { return Invoke<SkyCreatorBackgroundCloudSettings>(nameof(GetBackgroundCloudSettings)); }
    ...
    public class SkyCreatorFunctionLibrary : BlueprintFunctionLibrary
    {
        public SkyCreatorFunctionLibrary(nint addr) : base(addr) { }
        ...
        public CelestialPositionData GetRealSunPosition(float Latitude, float Longitude, float TimeZone, bool bIsDaylightSavingTime, DateTime DateTime) { return Invoke<CelestialPositionData>(nameof(GetRealSunPosition), Latitude, Longitude, TimeZone, bIsDaylightSavingTime, DateTime); }
        public CelestialPositionData GetRealMoonPosition(float Latitude, float Longitude, float TimeZone, bool bIsDaylightSavingTime, DateTime DateTime) { return Invoke<CelestialPositionData>(nameof(GetRealMoonPosition), Latitude, Longitude, TimeZone, bIsDaylightSavingTime, DateTime); }
    ...
    public class SkyCreatorWeatherPreset : DataAsset
    {
        public SkyCreatorWeatherPreset(nint addr) : base(addr) { }
        public Object Description { get { return this[nameof(Description)]; } set { this[nameof(Description)] = value; } }
        public SkyCreatorSkyAtmosphereSettings SkyAtmosphereSettings { get { return this[nameof(SkyAtmosphereSettings)].As<SkyCreatorSkyAtmosphereSettings>(); } set { this["SkyAtmosphereSettings"] = value; } }
        public SkyCreatorVolumetricCloudSettings VolumetricCloudSettings { get { return this[nameof(VolumetricCloudSettings)].As<SkyCreatorVolumetricCloudSettings>(); } set { this["VolumetricCloudSettings"] = value; } }
        public SkyCreatorBackgroundCloudSettings BackgroundCloudSettings { get { return this[nameof(BackgroundCloudSettings)].As<SkyCreatorBackgroundCloudSettings>(); } set { this["BackgroundCloudSettings"] = value; } }
        public SkyCreatorSkyLightSettings SkyLightSettings { get { return this[nameof(SkyLightSettings)].As<SkyCreatorSkyLightSettings>(); } set { this["SkyLightSettings"] = value; } }
        public SkyCreatorSunLightSettings SunLightSettings { get { return this[nameof(SunLightSettings)].As<SkyCreatorSunLightSettings>(); } set { this["SunLightSettings"] = value; } }
        public SkyCreatorMoonLightSettings MoonLightSettings { get { return this[nameof(MoonLightSettings)].As<SkyCreatorMoonLightSettings>(); } set { this["MoonLightSettings"] = value; } }
        public SkyCreatorExponentialHeightFogSettings ExponentialHeightFogSettings { get { return this[nameof(ExponentialHeightFogSettings)].As<SkyCreatorExponentialHeightFogSettings>(); } set { this["ExponentialHeightFogSettings"] = value; } }
        public SkyCreatorStarMapSettings StarMapSettings { get { return this[nameof(StarMapSettings)].As<SkyCreatorStarMapSettings>(); } set { this["StarMapSettings"] = value; } }
        public SkyCreatorWeatherFXSettings WeatherFXSettings { get { return this[nameof(WeatherFXSettings)].As<SkyCreatorWeatherFXSettings>(); } set { this["WeatherFXSettings"] = value; } }
        public SkyCreatorWeatherMaterialFXSettings WeatherMaterialFXSettings { get { return this[nameof(WeatherMaterialFXSettings)].As<SkyCreatorWeatherMaterialFXSettings>(); } set { this["WeatherMaterialFXSettings"] = value; } }
        public SkyCreatorWindSettings WindSettings { get { return this[nameof(WindSettings)].As<SkyCreatorWindSettings>(); } set { this["WindSettings"] = value; } }
        public SkyCreatorPostProcessSettings PostProcessSettings { get { return this[nameof(PostProcessSettings)].As<SkyCreatorPostProcessSettings>(); } set { this["PostProcessSettings"] = value; } }
        public SkyCreatorWeatherSettings GetWeatherPresetSettings() { return Invoke<SkyCreatorWeatherSettings>(nameof(GetWeatherPresetSettings)); }
    }
    public enum ESkyCreatorEditorWeatherType : int
    {
        EditorWeather_WeatherPreset = 0,
        EditorWeather_WeatherSettings = 1,
        EditorWeather_MAX = 2,
    }
    public enum ESkyCreatorSunPositionType : int
    {
        SunPositionType_Simple = 0,
        SunPositionType_Real = 1,
        SunPositionType_MAX = 2,
    }
    public enum ESkyCreatorMoonPositionType : int
    {
    ...
    public enum EVolumetricCloudRenderTargetMode : int
    {
    ...
    public enum EVolumetricCloudNoiseShapeResolution : int
    {
    ...
    public enum EVolumetricCloudNoiseDetailResolution : int
    {
    ...
    public enum ESkyCreatorStarMapRotationType : int
    {
    ...
    public class SkyCreatorLightningParameters : Object
    {
        public SkyCreatorLightningParameters(nint addr) : base(addr) { }
    ...
    public class CelestialPositionData : Object
    {
        public CelestialPositionData(nint addr) : base(addr) { }
    ...
    public class SkyCreatorSkyAtmosphereSettings : Object
    {
        public SkyCreatorSkyAtmosphereSettings(nint addr) : base(addr) { }
    ...
    public class SkyCreatorVolumetricCloudSettings : Object
    {
        public SkyCreatorVolumetricCloudSettings(nint addr) : base(addr) { }
    ...
    public class SkyCreatorBackgroundCloudSettings : Object
    {
        public SkyCreatorBackgroundCloudSettings(nint addr) : base(addr) { }
    ...
    public class SkyCreatorSkyLightSettings : Object
    {
        public SkyCreatorSkyLightSettings(nint addr) : base(addr) { }
    ...
    public class SkyCreatorSunLightSettings : Object
    {
        public SkyCreatorSunLightSettings(nint addr) : base(addr) { }
        public float Intensity { get { return this[nameof(Intensity)].GetValue<float>(); } set { this[nameof(Intensity)].SetValue<float>(value); } }
        public LinearColor LightColor { get { return this[nameof(LightColor)].As<LinearColor>(); } set { this["LightColor"] = value; } }
    ...
    public class SkyCreatorMoonLightSettings : Object
    {
        public SkyCreatorMoonLightSettings(nint addr) : base(addr) { }
        public float Intensity { get { return this[nameof(Intensity)].GetValue<float>(); } set { this[nameof(Intensity)].SetValue<float>(value); } }
        public LinearColor LightColor { get { return this[nameof(LightColor)].As<LinearColor>(); } set { this["LightColor"] = value; } }
        public float Temperature { get { return this[nameof(Temperature)].GetValue<float>(); } set { this[nameof(Temperature)].SetValue<float>(value); } }
        public float VolumetricScatteringIntensity { get { return this[nameof(VolumetricScatteringIntensity)].GetValue<float>(); } set { this[nameof(VolumetricScatteringIntensity)].SetValue<float>(value); } }
    ...
    public class SkyCreatorExponentialHeightFogSettings : Object
    {
        public SkyCreatorExponentialHeightFogSettings(nint addr) : base(addr) { }
    ...
    public class SkyCreatorStarMapSettings : Object
    {
        public SkyCreatorStarMapSettings(nint addr) : base(addr) { }
    ...
    public class SkyCreatorWeatherFXSettings : Object
    {
        public SkyCreatorWeatherFXSettings(nint addr) : base(addr) { }
    ...
    public class SkyCreatorWeatherMaterialFXSettings : Object
    {
        public SkyCreatorWeatherMaterialFXSettings(nint addr) : base(addr) { }
    ...
    public class SkyCreatorWindSettings : Object
    {
        public SkyCreatorWindSettings(nint addr) : base(addr) { }
    ...
    public class SkyCreatorPostProcessSettings : Object
    {
        public SkyCreatorPostProcessSettings(nint addr) : base(addr) { }
    ...
    public class SkyCreatorWeatherSettings : Object
    {
        public SkyCreatorWeatherSettings(nint addr) : base(addr) { }
        public SkyCreatorSkyAtmosphereSettings SkyAtmosphereSettings { get { return this[nameof(SkyAtmosphereSettings)].As<SkyCreatorSkyAtmosphereSettings>(); } set { this["SkyAtmosphereSettings"] = value; } }
        public SkyCreatorVolumetricCloudSettings VolumetricCloudSettings { get { return this[nameof(VolumetricCloudSettings)].As<SkyCreatorVolumetricCloudSettings>(); } set { this["VolumetricCloudSettings"] = value; } }
        public SkyCreatorBackgroundCloudSettings BackgroundCloudSettings { get { return this[nameof(BackgroundCloudSettings)].As<SkyCreatorBackgroundCloudSettings>(); } set { this["BackgroundCloudSettings"] = value; } }
        public SkyCreatorSkyLightSettings SkyLightSettings { get { return this[nameof(SkyLightSettings)].As<SkyCreatorSkyLightSettings>(); } set { this["SkyLightSettings"] = value; } }
